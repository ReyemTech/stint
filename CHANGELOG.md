...
* **alfred:** scaffold alfred-stint workflow ([b541045](https://github.com/ReyemTech/stint/commit/b541045429c2476fb9ffcd4afb16f18cce2726b0))
* **app+ui:** route stint://entry/<uuid> through to a highlighted Today row ([d384db7](https://github.com/ReyemTech/stint/commit/d384db76530b7820186cc8c619221a13a2fddacc))
* **app:** auto-enable api.enabled when stint widgets are configured ([336fc70](https://github.com/ReyemTech/stint/commit/336fc70645106e11823961ec949220164469b65a))
* **app:** expose list_tasks and set_entry_task Tauri commands ([7307799](https://github.com/ReyemTech/stint/commit/7307799ad68add114700db6f8a451ab3dedde97e))
* **app:** idle detector polling task + setup wiring ([633fa02](https://github.com/ReyemTech/stint/commit/633fa020a355d49ce37a25224f2fc3d158e6146f))
* **app:** idle detector state machine ([c72f409](https://github.com/ReyemTech/stint/commit/c72f409212e589db569c2f0d6cc5ad843c7c0e09))
* **app:** idle_keep/discard/split Tauri commands ([edfffa0](https://github.com/ReyemTech/stint/commit/edfffa0c39f31bc90df2f239e376ea258b61ffc1))
* **app:** Tauri build pipeline + setup hook for StintIntents framework ([041df36](https://github.com/ReyemTech/stint/commit/041df36acd7d229488022b0f1da2f268db8b8da1))
* **app:** write api.port discovery file on HTTP bind ([712f286](https://github.com/ReyemTech/stint/commit/712f28643e303e6b1a632c6e3cb4fd916770997f))
* **cli:** stint projects list-tasks <id> subcommand ([b67af22](https://github.com/ReyemTech/stint/commit/b67af222073b4d4a35255fc3f66d19b88c0063a9))
* **core:** extern "C" verb wrappers for Swift bridge ([3acde18](https://github.com/ReyemTech/stint/commit/3acde18953cdfc3be999c2566a95ce76572c301b))
* **core:** FFI envelope + panic safety scaffolding for Swift bridge ([58a7ed1](https://github.com/ReyemTech/stint/commit/58a7ed1114199fb15c25b8bb5fcc22bb2a584f53))
* **core:** FFI for settings, log forwarder, focus id, indexer notify ([2464134](https://github.com/ReyemTech/stint/commit/246413495d8a6e490184e513a150880ee14253e5))
* **core:** focus-default fallback in verbs::start ([a29c186](https://github.com/ReyemTech/stint/commit/a29c1869557f96e7bd8a1eda0a15106d0f1a8ff5))
* **core:** stint:// URL routes for projects and tasks ([2f1e95c](https://github.com/ReyemTech/stint/commit/2f1e95c5798fb8bd2985fe913f01e9444b743cbc))
* **core:** wire notify_indexer into verbs + pull_worker + C header ([5527501](https://github.com/ReyemTech/stint/commit/55275011018185b2a3688266f382f1d8e4d735bb))
* **raycast:** Current Timer command (detail view, polls every 5s) ([eb17993](https://github.com/ReyemTech/stint/commit/eb179933e0fc415bf4390fb3029e32e62044a07d))
* **raycast:** Recent Entries — browse + restart + copy + open in Stint ([689c92a](https://github.com/ReyemTech/stint/commit/689c92ab52eec5dfccc2f9a9828cc517101bbfa0))
* **raycast:** scaffold raycast-stint extension package ([165f7f7](https://github.com/ReyemTech/stint/commit/165f7f7074c55b3cb9bdb1280a5479fd79502cdd))
* **raycast:** Start Timer command (form with project + task) ([7cd786e](https://github.com/ReyemTech/stint/commit/7cd786eb15a79e11d079b2f79da29b15adbe21e9))
* **raycast:** Stop Timer command (no-view) ([8dd2ae8](https://github.com/ReyemTech/stint/commit/8dd2ae80417568f38e50e1fa589b09e2c1f39889))
* **raycast:** Switch Project — stop + start on new project preserving description ([5dc55d6](https://github.com/ReyemTech/stint/commit/5dc55d657e2777cce3ac05cdf3bbcfd08746056b))
* **swift:** StintIntents framework — 10 intents + 5 App Shortcuts + Focus filter ([e80af7d](https://github.com/ReyemTech/stint/commit/e80af7d9b71695ca06d0be0b6bf5cbc8a866ac51))
* **ui:** add api.listTasks + api.setEntryTask wrappers ([373b971](https://github.com/ReyemTech/stint/commit/373b971bef6b883c5ebdaf21fe0c18d8ff72a359))
* **ui:** idle detection settings — toggle + threshold dropdown ([6c1975c](https://github.com/ReyemTech/stint/commit/6c1975c504a4d19a9cff915d8eee4927cd21fdb3))
* **ui:** IdleBanner — listen for idle:detected + render 3 actions ([96391c3](https://github.com/ReyemTech/stint/commit/96391c31bcdfa99041975016d24efa1a8a749e33))
* **ui:** surface task name pill on EntryRow ([e5753e9](https://github.com/ReyemTech/stint/commit/e5753e94dd75e1546b4752d2fdb4da915055e4de))
* **ui:** TaskPicker combobox component ([3c1dfa2](https://github.com/ReyemTech/stint/commit/3c1dfa21a10d22aee1bc8799efb139642512dd93))
* **ui:** TaskPicker in EditEntryDialog Save flow ([e4210b2](https://github.com/ReyemTech/stint/commit/e4210b211e8bb74933b1280b502b6b4b5c077238))
* **ui:** TaskPicker in TimerCard for both start form and live entry ([6726a55](https://github.com/ReyemTech/stint/commit/6726a5549a311924f3e9b8113364a1d54aa412f3))
* **widget:** PortDiscovery + DTO coding + tests ([7faa0e9](https://github.com/ReyemTech/stint/commit/7faa0e97a031d4cac05fe3d2c1e97f907a883b96))
* **widget:** scaffold StintWidget Swift package ([012bff1](https://github.com/ReyemTech/stint/commit/012bff1adf3f7ae3fe538be05dd789830df707a3))
* **widget:** SwiftUI views for 3 widget kinds × 2 sizes ([b8d5de1](https://github.com/ReyemTech/stint/commit/b8d5de1463fd353bc66ad854418e875c8d9aa93e))
* **widget:** TimelineProvider + HTTP fetch via PortDiscovery ([e377b66](https://github.com/ReyemTech/stint/commit/e377b66ef18d30a07eb1b78a9d42577cfa9ca96f))
* **widget:** WidgetConfigurationIntent + Widget declaration + [@main](https://github.com/main) bundle ([1b5673b](https://github.com/ReyemTech/stint/commit/1b5673b174344bb5eb1b9ac29cb1a29054bbef24))

### Bug Fixes

* **app:** isolate api.port test env mutations + feature-gate test helpers ([c0f8e78](https://github.com/ReyemTech/stint/commit/c0f8e783ab4da45bcea128d939cbc680f3a97edd))
* **app:** link, export, and re-sign so StintIntents framework actually loads ([e89f14c](https://github.com/ReyemTech/stint/commit/e89f14c3f37226a3e0a1cad90ab1252491a5e52d))
* **build:** add absolute rpath for StintIntents framework so tests load ([5e0c982](https://github.com/ReyemTech/stint/commit/5e0c9822499ec97890fcc0f358681c6a85648196))
* **ci:** tolerate missing Metadata.appintents stencil ([fe8445a](https://github.com/ReyemTech/stint/commit/fe8445a5d79bd802248e8a1791cad8cc0cff4203))
* **swift:** revert to dynamic framework — static link clashed with WebKit ([6ca1068](https://github.com/ReyemTech/stint/commit/6ca106852e31c102290e15a16ecaaa5409a6fd05))
* **swift:** siri phrase set + bundle stencil at app level ([88211cf](https://github.com/ReyemTech/stint/commit/88211cf5f380f589513c16622c81fa57189e6af6))
* **widget:** app-sandbox entitlement + Info.plist platform keys ([52bb6a4](https://github.com/ReyemTech/stint/commit/52bb6a456cf0bc4f40231243a582aae3d5a5dbae))
* **widget:** build as executable target, not dynamic framework ([7385b50](https://github.com/ReyemTech/stint/commit/7385b502f01d0ce1dcd112d0eb4675332e441e90))
